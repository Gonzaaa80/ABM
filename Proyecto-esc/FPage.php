...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="style.css?75" />
    <!--JS-->
          ...
          <div class="row">
                  ...
                  >
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="Sources/perro slider1.jpg" class="d-block w-100 " alt="..." />
                      </div>
                      <div class="carousel-item">
                        <img src="Sources/perroslider2.jpg" class="d-block w-100 "  alt="..." />
                      </div>
                      <div class="carousel-item">
                        <img src="Sources/perroslider3.jpg?1" class="d-block w-100 " alt="..." />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="secciones">
              ...
              <div class="total-c">
                <div class="description_c">
                  <p class="p-c">
                    ¡Únete a nuestro equipo de paseadores de perros y conviértete en parte de una comunidad apasionada por el cuidado de las mascotas!
                    <br>
                    En PASEALO, valoramos el amor y la dedicación que los paseadores tienen hacia los perros. Nuestro servicio no solo se trata de pasear perros, sino de brindarles cuidado y atención de la más alta calidad, mientras proporcionamos a sus dueños la tranquilidad que necesitan.
                  </p>
                  <div class="accordion bg-primary" id="accordionExample2">
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" >
                          Elige a tu paseador
